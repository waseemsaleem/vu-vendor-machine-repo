...
namespace VendorMachine.ApiTests.Controllers
{
    public class RoleServiceTests
    {
        ...
        public async Task AddRole_AddsNewRole_ShouldReturn200Status()
        {
            ...
            // Act
            var result = (OkObjectResult)await sut.PostRole(RoleMockData._role);
        ...
        public async Task UpdateRole_UpdatesRole_ShouldReturn200Status()
        {
            ...
            // Act
            var result = (OkObjectResult)await sut.PutRole(RoleMockData._role.RoleId, RoleMockData._role);
        ...
        public async Task DeleteRole_DeleteRoleById_ShouldReturn200Status()
        {
            ...
            // Act
            var result = (OkObjectResult)await sut.DeleteRole(RoleMockData._role.RoleId);
